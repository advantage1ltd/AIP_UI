      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            ...
            <CardContent className="px-4 pb-4">
              ...
              <div className="flex items-center mt-1">
                <span className="text-xs text-blue-100">
                  Across {totalDeals} active deals
                </span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-sm hover:shadow-md transition-shadow bg-indigo-600">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-4 pt-4">
              <CardTitle className="text-xs sm:text-sm font-medium text-white">Average Deal Size</CardTitle>
              <div className="rounded-full bg-indigo-500/30 p-1.5 sm:p-2">
                <BarChart3 className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-white" />
              </div>
            </CardHeader>
            <CardContent className="px-4 pb-4">
              <div className="text-xl sm:text-2xl font-bold text-white">{formatCurrency(avgDealValue)}</div>
              <div className="flex items-center mt-1">

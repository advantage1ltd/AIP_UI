...
// Store-specific data for customer dashboard
...
// Regional data for head office view
const regionalData = {
...
interface CustomerDashboardProps {
  userRole: 'customer-site' | 'customer-ho'
}

function CustomerDashboard({ userRole }: CustomerDashboardProps) {
  // Add logging to debug role changes
  React.useEffect(() => {
    console.log('CustomerDashboard rendered with role:', userRole)
  }, [userRole])
  ...
  // Get current store/region data
  const currentStoreData = customerStoreData[selectedStore as keyof typeof customerStoreData]
  const metrics = currentStoreData?.metrics[userRole] || []
  ...
  // Add logging for metrics and data
  React.useEffect(() => {
    console.log('Current metrics:', metrics)
    console.log('Current incident data:', incidentData)
    console.log('Selected period:', selectedPeriod)
    console.log('Selected store:', selectedStore)
  }, [metrics, incidentData, selectedPeriod, selectedStore])
    ...
    <div className="min-h-screen w-full max-w-[100vw] overflow-x-hidden">
      <div className="container mx-auto px-2 md:px-4 space-y-4 max-w-full md:max-w-7xl">
        ...
        <div className="text-sm text-gray-500 mb-4">
          ...
          <br />
          Selected {isSiteManager ? 'Store' : 'Region'}: {isSiteManager ? currentStoreData?.name : regionalData[selectedRegion as keyof typeof regionalData]?.name}
          <br />
          Metrics Count: {metrics.length}
          <br />
          Incident Data Points: {incidentData.length}
        </div>
